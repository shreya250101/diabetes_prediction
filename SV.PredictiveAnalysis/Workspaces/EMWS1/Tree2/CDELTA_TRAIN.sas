...
if upcase(NAME) = "GENHLTH" then do;
ROLE = "REJECTED";
end;
else 
...
if upcase(NAME) = "HIGHBP" then do;
ROLE = "REJECTED";
end;
else 
if upcase(NAME) = "HIGHCHOL" then do;
ROLE = "REJECTED";
end;
else 
if upcase(NAME) = "HVYALCOHOLCONSUMP" then do;
ROLE = "REJECTED";
end;
else 
