  ...
  IF _ARBFMT_12 IN ('4' ,'5' ) THEN DO;
    ...
    ELSE DO;
      ...
      ELSE DO;
        _NODE_  =                   22;
        _LEAF_  =                    3;
        P_Diabetes_Predictionno_diabetes  =     0.43288126210905;
        P_Diabetes_Predictiondiabetes  =     0.52670910600608;
        P_Diabetes_Predictionprediabetes  =     0.04040963188486;
        Q_Diabetes_Predictionno_diabetes  =     0.43288126210905;
        Q_Diabetes_Predictiondiabetes  =     0.52670910600608;
        Q_Diabetes_Predictionprediabetes  =     0.04040963188486;
        V_Diabetes_Predictionno_diabetes  =     0.44871794871794;
        V_Diabetes_Predictiondiabetes  =     0.50829562594268;
        V_Diabetes_Predictionprediabetes  =     0.04298642533936;
