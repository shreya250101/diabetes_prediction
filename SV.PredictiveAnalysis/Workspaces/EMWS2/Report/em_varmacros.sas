...
%let EM_NUM_VARS = 26;
   ...
   HvyAlcoholConsump Q_Diabetes_Predictiondiabetes
   ...
   R_Diabetes_Predictionprediabetes U_Diabetes_Prediction
   V_Diabetes_Predictiondiabetes V_Diabetes_Predictionno_diabetes
   V_Diabetes_Predictionprediabetes _NODE_ _WARN_ _dataobs_ b_Diabetes_Prediction
   %mend EM_VARS;
%let EM_NUM_CLASS = 13;
   %macro EM_CLASS;
    Diabetes_Prediction EM_CLASSIFICATION EM_CLASSTARGET EM_SEGMENT
   F_Diabetes_Prediction GenHlth HighBP HighChol HvyAlcoholConsump
   U_Diabetes_Prediction _NODE_ _WARN_ b_Diabetes_Prediction
   %mend EM_CLASS;
...
%let EM_NUM_INPUT = 5;
   %macro EM_INPUT;
    BMI GenHlth HighBP HighChol HvyAlcoholConsump
   %mend EM_INPUT;
...
%let EM_NUM_REJECTS = 20;
   %macro EM_REJECTS;
    Age AnyHealthcare CholCheck DiffWalk Education Fruits HeartDiseaseorAttack
   I_Diabetes_Prediction Income MentHlth NoDocbcCost P_Diabetes_Predictiondiabetes
   P_Diabetes_Predictionno_diabetes P_Diabetes_Predictionprediabetes PhysActivity
