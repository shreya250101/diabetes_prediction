...
*** Target Values;
array REG3DRF [3] $11 _temporary_ ('PREDIABETES' 'NO DIABETES' 'DIABETES' );
label U_Diabetes_Prediction = 'Unnormalized Into: Diabetes_Prediction' ;
length U_Diabetes_Prediction $ 11;
*** Unnormalized target values;
array REG3DRU[3] $ 11 _temporary_ ('prediabetes'  'no diabetes'  
'diabetes   ' );
...
I_Diabetes_Prediction = REG3DRF[_IY];
U_Diabetes_Prediction = REG3DRU[_IY];
