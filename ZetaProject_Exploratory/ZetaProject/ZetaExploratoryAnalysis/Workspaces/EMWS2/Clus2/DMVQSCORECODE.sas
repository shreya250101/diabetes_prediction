...
if not missing( T_Age ) then do;
   CLUS2vads [1] + ( T_Age - 0.42184681145588 )**2;
   CLUS2vads [2] + ( T_Age - -0.19528322070761 )**2;
end;
else _vqmvar + 1;
if not missing( T_BMI ) then do;
   CLUS2vads [1] + ( T_BMI - 0.35557592040749 )**2;
   CLUS2vads [2] + ( T_BMI - -0.1646048021643 )**2;
end;
else _vqmvar + 1;
if not missing( AnyHealthcare0 ) then do;
   CLUS2vads [1] + ( AnyHealthcare0 - 0.05876880098551 )**2;
   CLUS2vads [2] + ( AnyHealthcare0 - -0.02720551731536 )**2;
end;
else _vqmvar + 0.5;
if not missing( AnyHealthcare1 ) then do;
   CLUS2vads [1] + ( AnyHealthcare1 - -0.05876880098551 )**2;
   CLUS2vads [2] + ( AnyHealthcare1 - 0.02720551731536 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( CholCheck0 ) then do;
   CLUS2vads [1] + ( CholCheck0 - -0.06160551438692 )**2;
   CLUS2vads [2] + ( CholCheck0 - 0.02851870142449 )**2;
end;
else _vqmvar + 0.5;
if not missing( CholCheck1 ) then do;
   CLUS2vads [1] + ( CholCheck1 - 0.06160551438692 )**2;
   CLUS2vads [2] + ( CholCheck1 - -0.02851870142449 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( DiffWalk0 ) then do;
   CLUS2vads [1] + ( DiffWalk0 - -0.60277936734095 )**2;
   CLUS2vads [2] + ( DiffWalk0 - 0.2790413321456 )**2;
end;
else _vqmvar + 0.5;
if not missing( DiffWalk1 ) then do;
   CLUS2vads [1] + ( DiffWalk1 - 0.60277936734095 )**2;
   CLUS2vads [2] + ( DiffWalk1 - -0.2790413321456 )**2;
end;
else _vqmvar + 0.5;
if not missing( Fruits0 ) then do;
   CLUS2vads [1] + ( Fruits0 - 0.13930833715652 )**2;
   CLUS2vads [2] + ( Fruits0 - -0.06448924114748 )**2;
end;
else _vqmvar + 0.5;
if not missing( Fruits1 ) then do;
   CLUS2vads [1] + ( Fruits1 - -0.13930833715652 )**2;
   CLUS2vads [2] + ( Fruits1 - 0.06448924114748 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HeartDiseaseorAttack0 ) then do;
   CLUS2vads [1] + ( HeartDiseaseorAttack0 - -0.36364500761233 )**2;
   CLUS2vads [2] + ( HeartDiseaseorAttack0 - 0.16834018025464 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HeartDiseaseorAttack1 ) then do;
   CLUS2vads [1] + ( HeartDiseaseorAttack1 - 0.36364500761233 )**2;
   CLUS2vads [2] + ( HeartDiseaseorAttack1 - -0.16834018025464 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighBP0 ) then do;
   CLUS2vads [1] + ( HighBP0 - -0.41693250517112 )**2;
   CLUS2vads [2] + ( HighBP0 - 0.19300826796957 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighBP1 ) then do;
   CLUS2vads [1] + ( HighBP1 - 0.41693250517112 )**2;
   CLUS2vads [2] + ( HighBP1 - -0.19300826796957 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol0 ) then do;
   CLUS2vads [1] + ( HighChol0 - -0.29878653804832 )**2;
   CLUS2vads [2] + ( HighChol0 - 0.13831560620938 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol1 ) then do;
   CLUS2vads [1] + ( HighChol1 - 0.29878653804832 )**2;
   CLUS2vads [2] + ( HighChol1 - -0.13831560620938 )**2;
end;
else _vqmvar + 0.5;
if not missing( HvyAlcoholConsump0 ) then do;
   CLUS2vads [1] + ( HvyAlcoholConsump0 - 0.04994435920007 )**2;
   CLUS2vads [2] + ( HvyAlcoholConsump0 - -0.02312046708884 )**2;
end;
else _vqmvar + 0.5;
if not missing( HvyAlcoholConsump1 ) then do;
   CLUS2vads [1] + ( HvyAlcoholConsump1 - -0.04994435920007 )**2;
   CLUS2vads [2] + ( HvyAlcoholConsump1 - 0.02312046708884 )**2;
end;
else _vqmvar + 0.5;
if not missing( NoDocbcCost0 ) then do;
   CLUS2vads [1] + ( NoDocbcCost0 - -0.2101089136713 )**2;
   CLUS2vads [2] + ( NoDocbcCost0 - 0.09726456203285 )**2;
end;
else _vqmvar + 0.5;
if not missing( NoDocbcCost1 ) then do;
   CLUS2vads [1] + ( NoDocbcCost1 - 0.2101089136713 )**2;
   CLUS2vads [2] + ( NoDocbcCost1 - -0.09726456203285 )**2;
end;
else _vqmvar + 0.5;
if not missing( PhysActivity0 ) then do;
   CLUS2vads [1] + ( PhysActivity0 - 0.38493719538107 )**2;
   CLUS2vads [2] + ( PhysActivity0 - -0.17819685545195 )**2;
end;
else _vqmvar + 0.5;
if not missing( PhysActivity1 ) then do;
   CLUS2vads [1] + ( PhysActivity1 - -0.38493719538107 )**2;
   CLUS2vads [2] + ( PhysActivity1 - 0.17819685545195 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Sex0 ) then do;
   CLUS2vads [1] + ( Sex0 - 0.04590548241346 )**2;
   CLUS2vads [2] + ( Sex0 - -0.02125077210582 )**2;
end;
else _vqmvar + 0.5;
if not missing( Sex1 ) then do;
   CLUS2vads [1] + ( Sex1 - -0.04590548241346 )**2;
   CLUS2vads [2] + ( Sex1 - 0.02125077210582 )**2;
end;
else _vqmvar + 0.5;
if not missing( Smoker0 ) then do;
   CLUS2vads [1] + ( Smoker0 - -0.22841623999465 )**2;
   CLUS2vads [2] + ( Smoker0 - 0.10573947176221 )**2;
end;
else _vqmvar + 0.5;
if not missing( Smoker1 ) then do;
   CLUS2vads [1] + ( Smoker1 - 0.22841623999465 )**2;
   CLUS2vads [2] + ( Smoker1 - -0.10573947176221 )**2;
end;
else _vqmvar + 0.5;
if not missing( Stroke0 ) then do;
   CLUS2vads [1] + ( Stroke0 - -0.25492440634086 )**2;
   CLUS2vads [2] + ( Stroke0 - 0.11801075118998 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Stroke1 ) then do;
   CLUS2vads [1] + ( Stroke1 - 0.25492440634086 )**2;
   CLUS2vads [2] + ( Stroke1 - -0.11801075118998 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Veggies0 ) then do;
   CLUS2vads [1] + ( Veggies0 - 0.20122345955718 )**2;
   CLUS2vads [2] + ( Veggies0 - -0.09315126770411 )**2;
end;
else _vqmvar + 0.5;
if not missing( Veggies1 ) then do;
   CLUS2vads [1] + ( Veggies1 - -0.20122345955718 )**2;
   CLUS2vads [2] + ( Veggies1 - 0.09315126770411 )**2;
end;
else _vqmvar + 0.5;
if not missing( T_Education ) then do;
   CLUS2vads [1] + ( T_Education - -0.55448800541977 )**2;
   CLUS2vads [2] + ( T_Education - 0.25668607798119 )**2;
end;
else _vqmvar + 1;
if not missing( T_GenHlth ) then do;
   CLUS2vads [1] + ( T_GenHlth - 0.89094562531727 )**2;
   CLUS2vads [2] + ( T_GenHlth - -0.4124405506023 )**2;
end;
else _vqmvar + 1;
if not missing( T_Income ) then do;
   CLUS2vads [1] + ( T_Income - -0.70970556764715 )**2;
   CLUS2vads [2] + ( T_Income - 0.3285400890559 )**2;
end;
else _vqmvar + 1;
if not missing( T_MentHlth ) then do;
   CLUS2vads [1] + ( T_MentHlth - 0.35787613830386 )**2;
   CLUS2vads [2] + ( T_MentHlth - -0.16566962936395 )**2;
end;
else _vqmvar + 1;
if not missing( T_PhysHlth ) then do;
   CLUS2vads [1] + ( T_PhysHlth - 0.72892570699831 )**2;
   CLUS2vads [2] + ( T_PhysHlth - -0.33743756229428 )**2;
end;
else _vqmvar + 1;
_vqnvar = 21 - _vqmvar;
