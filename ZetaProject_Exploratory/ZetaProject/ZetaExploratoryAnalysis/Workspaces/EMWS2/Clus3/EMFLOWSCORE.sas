...
if not missing( T_Age ) then do;
   CLUS3vads [1] + ( T_Age - -0.17073687768612 )**2;
   CLUS3vads [2] + ( T_Age - -0.54886255831279 )**2;
   CLUS3vads [3] + ( T_Age - -0.37557884096061 )**2;
   CLUS3vads [4] + ( T_Age - 0.56908428667211 )**2;
end;
else _vqmvar + 1;
if not missing( T_BMI ) then do;
   CLUS3vads [1] + ( T_BMI - -0.17320313019188 )**2;
   CLUS3vads [2] + ( T_BMI - -0.13454865662491 )**2;
   CLUS3vads [3] + ( T_BMI - 0.18899468881167 )**2;
   CLUS3vads [4] + ( T_BMI - 0.33368216796073 )**2;
end;
else _vqmvar + 1;
if not missing( AnyHealthcare0 ) then do;
   CLUS3vads [1] + ( AnyHealthcare0 - -0.15929186780222 )**2;
   CLUS3vads [2] + ( AnyHealthcare0 - 1.47335052719 )**2;
   CLUS3vads [3] + ( AnyHealthcare0 - 0.48333921173056 )**2;
   CLUS3vads [4] + ( AnyHealthcare0 - -0.11640393798596 )**2;
end;
else _vqmvar + 0.5;
if not missing( AnyHealthcare1 ) then do;
   CLUS3vads [1] + ( AnyHealthcare1 - 0.15929186780222 )**2;
   CLUS3vads [2] + ( AnyHealthcare1 - -1.47335052719 )**2;
   CLUS3vads [3] + ( AnyHealthcare1 - -0.48333921173056 )**2;
   CLUS3vads [4] + ( AnyHealthcare1 - 0.11640393798596 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( CholCheck0 ) then do;
   CLUS3vads [1] + ( CholCheck0 - -0.1397881757199 )**2;
   CLUS3vads [2] + ( CholCheck0 - 2.14569015326873 )**2;
   CLUS3vads [3] + ( CholCheck0 - -0.11658637305622 )**2;
   CLUS3vads [4] + ( CholCheck0 - -0.13766609385084 )**2;
end;
else _vqmvar + 0.5;
if not missing( CholCheck1 ) then do;
   CLUS3vads [1] + ( CholCheck1 - 0.1397881757199 )**2;
   CLUS3vads [2] + ( CholCheck1 - -2.14569015326873 )**2;
   CLUS3vads [3] + ( CholCheck1 - 0.11658637305622 )**2;
   CLUS3vads [4] + ( CholCheck1 - 0.13766609385084 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( DiffWalk0 ) then do;
   CLUS3vads [1] + ( DiffWalk0 - 0.28101671004593 )**2;
   CLUS3vads [2] + ( DiffWalk0 - 0.1964359948253 )**2;
   CLUS3vads [3] + ( DiffWalk0 - -0.29630543068391 )**2;
   CLUS3vads [4] + ( DiffWalk0 - -0.53952518385211 )**2;
end;
else _vqmvar + 0.5;
if not missing( DiffWalk1 ) then do;
   CLUS3vads [1] + ( DiffWalk1 - -0.28101671004593 )**2;
   CLUS3vads [2] + ( DiffWalk1 - -0.1964359948253 )**2;
   CLUS3vads [3] + ( DiffWalk1 - 0.29630543068391 )**2;
   CLUS3vads [4] + ( DiffWalk1 - 0.53952518385211 )**2;
end;
else _vqmvar + 0.5;
if not missing( Fruits0 ) then do;
   CLUS3vads [1] + ( Fruits0 - -0.07653937436545 )**2;
   CLUS3vads [2] + ( Fruits0 - 0.06960326719869 )**2;
   CLUS3vads [3] + ( Fruits0 - 0.09805164327887 )**2;
   CLUS3vads [4] + ( Fruits0 - 0.1160775046378 )**2;
end;
else _vqmvar + 0.5;
if not missing( Fruits1 ) then do;
   CLUS3vads [1] + ( Fruits1 - 0.07653937436545 )**2;
   CLUS3vads [2] + ( Fruits1 - -0.06960326719869 )**2;
   CLUS3vads [3] + ( Fruits1 - -0.09805164327887 )**2;
   CLUS3vads [4] + ( Fruits1 - -0.1160775046378 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HeartDiseaseorAttack0 ) then do;
   CLUS3vads [1] + ( HeartDiseaseorAttack0 - 0.17794907637385 )**2;
   CLUS3vads [2] + ( HeartDiseaseorAttack0 - 0.17235567247688 )**2;
   CLUS3vads [3] + ( HeartDiseaseorAttack0 - -0.08421878765838 )**2;
   CLUS3vads [4] + ( HeartDiseaseorAttack0 - -0.37975142392051 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HeartDiseaseorAttack1 ) then do;
   CLUS3vads [1] + ( HeartDiseaseorAttack1 - -0.17794907637385 )**2;
   CLUS3vads [2] + ( HeartDiseaseorAttack1 - -0.17235567247688 )**2;
   CLUS3vads [3] + ( HeartDiseaseorAttack1 - 0.08421878765838 )**2;
   CLUS3vads [4] + ( HeartDiseaseorAttack1 - 0.37975142392051 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighBP0 ) then do;
   CLUS3vads [1] + ( HighBP0 - 0.1984858679318 )**2;
   CLUS3vads [2] + ( HighBP0 - 0.31727165347489 )**2;
   CLUS3vads [3] + ( HighBP0 - -0.06201508684588 )**2;
   CLUS3vads [4] + ( HighBP0 - -0.4587894377384 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighBP1 ) then do;
   CLUS3vads [1] + ( HighBP1 - -0.1984858679318 )**2;
   CLUS3vads [2] + ( HighBP1 - -0.31727165347489 )**2;
   CLUS3vads [3] + ( HighBP1 - 0.06201508684588 )**2;
   CLUS3vads [4] + ( HighBP1 - 0.4587894377384 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol0 ) then do;
   CLUS3vads [1] + ( HighChol0 - 0.1337924512141 )**2;
   CLUS3vads [2] + ( HighChol0 - 0.29114895170325 )**2;
   CLUS3vads [3] + ( HighChol0 - -0.04998268671593 )**2;
   CLUS3vads [4] + ( HighChol0 - -0.32348925871518 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol1 ) then do;
   CLUS3vads [1] + ( HighChol1 - -0.1337924512141 )**2;
   CLUS3vads [2] + ( HighChol1 - -0.29114895170325 )**2;
   CLUS3vads [3] + ( HighChol1 - 0.04998268671593 )**2;
   CLUS3vads [4] + ( HighChol1 - 0.32348925871518 )**2;
end;
else _vqmvar + 0.5;
if not missing( HvyAlcoholConsump0 ) then do;
   CLUS3vads [1] + ( HvyAlcoholConsump0 - -0.02090211276025 )**2;
   CLUS3vads [2] + ( HvyAlcoholConsump0 - -0.06331955000076 )**2;
   CLUS3vads [3] + ( HvyAlcoholConsump0 - -0.00529648129567 )**2;
   CLUS3vads [4] + ( HvyAlcoholConsump0 - 0.05786805737679 )**2;
end;
else _vqmvar + 0.5;
if not missing( HvyAlcoholConsump1 ) then do;
   CLUS3vads [1] + ( HvyAlcoholConsump1 - 0.02090211276025 )**2;
   CLUS3vads [2] + ( HvyAlcoholConsump1 - 0.06331955000076 )**2;
   CLUS3vads [3] + ( HvyAlcoholConsump1 - 0.00529648129567 )**2;
   CLUS3vads [4] + ( HvyAlcoholConsump1 - -0.05786805737679 )**2;
end;
else _vqmvar + 0.5;
if not missing( NoDocbcCost0 ) then do;
   CLUS3vads [1] + ( NoDocbcCost0 - 0.20985406085303 )**2;
   CLUS3vads [2] + ( NoDocbcCost0 - -0.0324997624154 )**2;
   CLUS3vads [3] + ( NoDocbcCost0 - -2.35813218154295 )**2;
   CLUS3vads [4] + ( NoDocbcCost0 - 0.2117745530562 )**2;
end;
else _vqmvar + 0.5;
if not missing( NoDocbcCost1 ) then do;
   CLUS3vads [1] + ( NoDocbcCost1 - -0.20985406085303 )**2;
   CLUS3vads [2] + ( NoDocbcCost1 - 0.0324997624154 )**2;
   CLUS3vads [3] + ( NoDocbcCost1 - 2.35813218154295 )**2;
   CLUS3vads [4] + ( NoDocbcCost1 - -0.2117745530562 )**2;
end;
else _vqmvar + 0.5;
if not missing( PhysActivity0 ) then do;
   CLUS3vads [1] + ( PhysActivity0 - -0.19560119858489 )**2;
   CLUS3vads [2] + ( PhysActivity0 - 0.00565072632846 )**2;
   CLUS3vads [3] + ( PhysActivity0 - 0.14703913838663 )**2;
   CLUS3vads [4] + ( PhysActivity0 - 0.3612190703559 )**2;
end;
else _vqmvar + 0.5;
if not missing( PhysActivity1 ) then do;
   CLUS3vads [1] + ( PhysActivity1 - 0.19560119858489 )**2;
   CLUS3vads [2] + ( PhysActivity1 - -0.00565072632846 )**2;
   CLUS3vads [3] + ( PhysActivity1 - -0.14703913838663 )**2;
   CLUS3vads [4] + ( PhysActivity1 - -0.3612190703559 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Sex0 ) then do;
   CLUS3vads [1] + ( Sex0 - -0.01646782778892 )**2;
   CLUS3vads [2] + ( Sex0 - -0.09940480875774 )**2;
   CLUS3vads [3] + ( Sex0 - 0.10765521533053 )**2;
   CLUS3vads [4] + ( Sex0 - 0.02595368951866 )**2;
end;
else _vqmvar + 0.5;
if not missing( Sex1 ) then do;
   CLUS3vads [1] + ( Sex1 - 0.01646782778892 )**2;
   CLUS3vads [2] + ( Sex1 - 0.09940480875774 )**2;
   CLUS3vads [3] + ( Sex1 - -0.10765521533053 )**2;
   CLUS3vads [4] + ( Sex1 - -0.02595368951866 )**2;
end;
else _vqmvar + 0.5;
if not missing( Smoker0 ) then do;
   CLUS3vads [1] + ( Smoker0 - 0.12342913357978 )**2;
   CLUS3vads [2] + ( Smoker0 - -0.00747319811924 )**2;
   CLUS3vads [3] + ( Smoker0 - -0.11509525302599 )**2;
   CLUS3vads [4] + ( Smoker0 - -0.22108725586349 )**2;
end;
else _vqmvar + 0.5;
if not missing( Smoker1 ) then do;
   CLUS3vads [1] + ( Smoker1 - -0.12342913357978 )**2;
   CLUS3vads [2] + ( Smoker1 - 0.00747319811924 )**2;
   CLUS3vads [3] + ( Smoker1 - 0.11509525302599 )**2;
   CLUS3vads [4] + ( Smoker1 - 0.22108725586349 )**2;
end;
else _vqmvar + 0.5;
if not missing( Stroke0 ) then do;
   CLUS3vads [1] + ( Stroke0 - 0.12040461702293 )**2;
   CLUS3vads [2] + ( Stroke0 - 0.10653857312591 )**2;
   CLUS3vads [3] + ( Stroke0 - -0.09155009349719 )**2;
   CLUS3vads [4] + ( Stroke0 - -0.24547791963416 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Stroke1 ) then do;
   CLUS3vads [1] + ( Stroke1 - -0.12040461702293 )**2;
   CLUS3vads [2] + ( Stroke1 - -0.10653857312591 )**2;
   CLUS3vads [3] + ( Stroke1 - 0.09155009349719 )**2;
   CLUS3vads [4] + ( Stroke1 - 0.24547791963416 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Veggies0 ) then do;
   CLUS3vads [1] + ( Veggies0 - -0.10664597000402 )**2;
   CLUS3vads [2] + ( Veggies0 - 0.03032081781974 )**2;
   CLUS3vads [3] + ( Veggies0 - 0.08039630112162 )**2;
   CLUS3vads [4] + ( Veggies0 - 0.19108789719126 )**2;
end;
else _vqmvar + 0.5;
if not missing( Veggies1 ) then do;
   CLUS3vads [1] + ( Veggies1 - 0.10664597000402 )**2;
   CLUS3vads [2] + ( Veggies1 - -0.03032081781974 )**2;
   CLUS3vads [3] + ( Veggies1 - -0.08039630112162 )**2;
   CLUS3vads [4] + ( Veggies1 - -0.19108789719126 )**2;
end;
else _vqmvar + 0.5;
if not missing( T_Education ) then do;
   CLUS3vads [1] + ( T_Education - 0.31576135265849 )**2;
   CLUS3vads [2] + ( T_Education - -0.17069319486655 )**2;
   CLUS3vads [3] + ( T_Education - -0.33445003742183 )**2;
   CLUS3vads [4] + ( T_Education - -0.52255272491837 )**2;
end;
else _vqmvar + 1;
if not missing( T_GenHlth ) then do;
   CLUS3vads [1] + ( T_GenHlth - -0.44868687869402 )**2;
   CLUS3vads [2] + ( T_GenHlth - -0.20808827020188 )**2;
   CLUS3vads [3] + ( T_GenHlth - 0.54915773785372 )**2;
   CLUS3vads [4] + ( T_GenHlth - 0.81845825453329 )**2;
end;
else _vqmvar + 1;
if not missing( T_Income ) then do;
   CLUS3vads [1] + ( T_Income - 0.41051066481661 )**2;
   CLUS3vads [2] + ( T_Income - -0.21797853361429 )**2;
   CLUS3vads [3] + ( T_Income - -0.65959569897287 )**2;
   CLUS3vads [4] + ( T_Income - -0.61953926009677 )**2;
end;
else _vqmvar + 1;
if not missing( T_MentHlth ) then do;
   CLUS3vads [1] + ( T_MentHlth - -0.17899400019841 )**2;
   CLUS3vads [2] + ( T_MentHlth - 0.00147572456578 )**2;
   CLUS3vads [3] + ( T_MentHlth - 0.61267346099112 )**2;
   CLUS3vads [4] + ( T_MentHlth - 0.20233406120762 )**2;
end;
else _vqmvar + 1;
if not missing( T_PhysHlth ) then do;
   CLUS3vads [1] + ( T_PhysHlth - -0.3410116964186 )**2;
   CLUS3vads [2] + ( T_PhysHlth - -0.2245141060454 )**2;
   CLUS3vads [3] + ( T_PhysHlth - 0.5362193726298 )**2;
   CLUS3vads [4] + ( T_PhysHlth - 0.60409753755895 )**2;
end;
else _vqmvar + 1;
_vqnvar = 21 - _vqmvar;
