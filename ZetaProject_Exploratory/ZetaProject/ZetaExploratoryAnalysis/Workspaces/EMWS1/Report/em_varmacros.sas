...
%let EM_NUM_VARS = 22;
   ...
   NoDocbcCost PhysActivity PhysHlth Sex Smoker Stroke Veggies _SEGMENT_
   %mend EM_VARS;
%let EM_NUM_CLASS = 20;
   %macro EM_CLASS;
    AnyHealthcare CholCheck DiffWalk Education Fruits GenHlth HeartDiseaseorAttack
   HighBP HighChol HvyAlcoholConsump Income MentHlth NoDocbcCost PhysActivity
...
%let EM_NUM_REJECTS = 3;
   %macro EM_REJECTS;
    Diabetes_012 Distance _SEGMENT_LABEL_
   %mend EM_REJECTS;
