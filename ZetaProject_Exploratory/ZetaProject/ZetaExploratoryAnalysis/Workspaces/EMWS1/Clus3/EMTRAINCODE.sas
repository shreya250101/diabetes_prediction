...
code file="\\uisnutvdiprof1a\redirected$\bkris2\Documents\ZetaProject\ZetaExploratoryAnalysis\Workspaces\EMWS1\Clus3\DMVQSCORECODE.sas"
group=Clus3
;
run;
quit;
...
*------------------------------------------------------------*;
proc cluster data=EMWS1.Clus3_OUTMEAN method=CENTROID pseudo outtree=EMWS1.Clus3_CLUSSEED
;
var %dmvqvars;
copy _SEGMENT_;
run;
