...
if not missing( T_Age ) then do;
   CLUS2vads [1] + ( T_Age - 0.53969887226305 )**2;
   CLUS2vads [2] + ( T_Age - -0.61546938269952 )**2;
   CLUS2vads [3] + ( T_Age - -0.11065670097039 )**2;
end;
else _vqmvar + 1;
if not missing( T_BMI ) then do;
   CLUS2vads [1] + ( T_BMI - 0.36930905457931 )**2;
   CLUS2vads [2] + ( T_BMI - -0.04774488780789 )**2;
   CLUS2vads [3] + ( T_BMI - -0.1393895396938 )**2;
end;
else _vqmvar + 1;
if not missing( AnyHealthcare0 ) then do;
   CLUS2vads [1] + ( AnyHealthcare0 - -0.12265228381376 )**2;
   CLUS2vads [2] + ( AnyHealthcare0 - 1.2217161985906 )**2;
   CLUS2vads [3] + ( AnyHealthcare0 - -0.15931135162852 )**2;
end;
else _vqmvar + 0.5;
if not missing( AnyHealthcare1 ) then do;
   CLUS2vads [1] + ( AnyHealthcare1 - 0.12265228381376 )**2;
   CLUS2vads [2] + ( AnyHealthcare1 - -1.2217161985906 )**2;
   CLUS2vads [3] + ( AnyHealthcare1 - 0.15931135162852 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( CholCheck0 ) then do;
   CLUS2vads [1] + ( CholCheck0 - -0.12800484033715 )**2;
   CLUS2vads [2] + ( CholCheck0 - 1.12118872244066 )**2;
   CLUS2vads [3] + ( CholCheck0 - -0.14003274976372 )**2;
end;
else _vqmvar + 0.5;
if not missing( CholCheck1 ) then do;
   CLUS2vads [1] + ( CholCheck1 - 0.12800484033715 )**2;
   CLUS2vads [2] + ( CholCheck1 - -1.12118872244066 )**2;
   CLUS2vads [3] + ( CholCheck1 - 0.14003274976372 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( DiffWalk0 ) then do;
   CLUS2vads [1] + ( DiffWalk0 - -0.76313335535289 )**2;
   CLUS2vads [2] + ( DiffWalk0 - 0.16352220339809 )**2;
   CLUS2vads [3] + ( DiffWalk0 - 0.27697251041048 )**2;
end;
else _vqmvar + 0.5;
if not missing( DiffWalk1 ) then do;
   CLUS2vads [1] + ( DiffWalk1 - 0.76313335535289 )**2;
   CLUS2vads [2] + ( DiffWalk1 - -0.16352220339809 )**2;
   CLUS2vads [3] + ( DiffWalk1 - -0.27697251041048 )**2;
end;
else _vqmvar + 0.5;
if not missing( Fruits0 ) then do;
   CLUS2vads [1] + ( Fruits0 - 0.12343332942892 )**2;
   CLUS2vads [2] + ( Fruits0 - 0.07100036254016 )**2;
   CLUS2vads [3] + ( Fruits0 - -0.06141458095452 )**2;
end;
else _vqmvar + 0.5;
if not missing( Fruits1 ) then do;
   CLUS2vads [1] + ( Fruits1 - -0.12343332942892 )**2;
   CLUS2vads [2] + ( Fruits1 - -0.07100036254016 )**2;
   CLUS2vads [3] + ( Fruits1 - 0.06141458095452 )**2;
end;
else _vqmvar + 0.5;
if not missing( HeartDiseaseorAttack0 ) then do;
   CLUS2vads [1] + ( HeartDiseaseorAttack0 - -0.47239263320329 )**2;
   CLUS2vads [2] + ( HeartDiseaseorAttack0 - 0.16035979448278 )**2;
   CLUS2vads [3] + ( HeartDiseaseorAttack0 - 0.16136765517917 )**2;
end;
else _vqmvar + 0.5;
if not missing( HeartDiseaseorAttack1 ) then do;
   CLUS2vads [1] + ( HeartDiseaseorAttack1 - 0.47239263320329 )**2;
   CLUS2vads [2] + ( HeartDiseaseorAttack1 - -0.16035979448278 )**2;
   CLUS2vads [3] + ( HeartDiseaseorAttack1 - -0.16136765517917 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighBP0 ) then do;
   CLUS2vads [1] + ( HighBP0 - -0.46430618229414 )**2;
   CLUS2vads [2] + ( HighBP0 - 0.24076942025178 )**2;
   CLUS2vads [3] + ( HighBP0 - 0.14442710996734 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighBP1 ) then do;
   CLUS2vads [1] + ( HighBP1 - 0.46430618229414 )**2;
   CLUS2vads [2] + ( HighBP1 - -0.24076942025178 )**2;
   CLUS2vads [3] + ( HighBP1 - -0.14442710996734 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol0 ) then do;
   CLUS2vads [1] + ( HighChol0 - -0.33812212873419 )**2;
   CLUS2vads [2] + ( HighChol0 - 0.22014109155754 )**2;
   CLUS2vads [3] + ( HighChol0 - 0.09753677900308 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighChol1 ) then do;
   CLUS2vads [1] + ( HighChol1 - 0.33812212873419 )**2;
   CLUS2vads [2] + ( HighChol1 - -0.22014109155754 )**2;
   CLUS2vads [3] + ( HighChol1 - -0.09753677900308 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HvyAlcoholConsump0 ) then do;
   CLUS2vads [1] + ( HvyAlcoholConsump0 - 0.06617606432324 )**2;
   CLUS2vads [2] + ( HvyAlcoholConsump0 - -0.05818027989413 )**2;
   CLUS2vads [3] + ( HvyAlcoholConsump0 - -0.0165157801343 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HvyAlcoholConsump1 ) then do;
   CLUS2vads [1] + ( HvyAlcoholConsump1 - -0.06617606432324 )**2;
   CLUS2vads [2] + ( HvyAlcoholConsump1 - 0.05818027989413 )**2;
   CLUS2vads [3] + ( HvyAlcoholConsump1 - 0.0165157801343 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( NoDocbcCost0 ) then do;
   CLUS2vads [1] + ( NoDocbcCost0 - -0.05439123054683 )**2;
   CLUS2vads [2] + ( NoDocbcCost0 - -1.04885057660903 )**2;
   CLUS2vads [3] + ( NoDocbcCost0 - 0.20056170181343 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( NoDocbcCost1 ) then do;
   CLUS2vads [1] + ( NoDocbcCost1 - 0.05439123054683 )**2;
   CLUS2vads [2] + ( NoDocbcCost1 - 1.04885057660903 )**2;
   CLUS2vads [3] + ( NoDocbcCost1 - -0.20056170181343 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( PhysActivity0 ) then do;
   CLUS2vads [1] + ( PhysActivity0 - 0.41463697194409 )**2;
   CLUS2vads [2] + ( PhysActivity0 - 0.00844749445782 )**2;
   CLUS2vads [3] + ( PhysActivity0 - -0.16707802451306 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( PhysActivity1 ) then do;
   CLUS2vads [1] + ( PhysActivity1 - -0.41463697194409 )**2;
   CLUS2vads [2] + ( PhysActivity1 - -0.00844749445782 )**2;
   CLUS2vads [3] + ( PhysActivity1 - 0.16707802451306 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Sex0 ) then do;
   CLUS2vads [1] + ( Sex0 - 0.05105650956478 )**2;
   CLUS2vads [2] + ( Sex0 - -0.00566435519373 )**2;
   CLUS2vads [3] + ( Sex0 - -0.01943007341023 )**2;
end;
else _vqmvar + 0.5;
if not missing( Sex1 ) then do;
   CLUS2vads [1] + ( Sex1 - -0.05105650956478 )**2;
   CLUS2vads [2] + ( Sex1 - 0.00566435519373 )**2;
   CLUS2vads [3] + ( Sex1 - 0.01943007341023 )**2;
end;
else _vqmvar + 0.5;
if not missing( Smoker0 ) then do;
   CLUS2vads [1] + ( Smoker0 - -0.23840148022303 )**2;
   CLUS2vads [2] + ( Smoker0 - -0.02692721593642 )**2;
   CLUS2vads [3] + ( Smoker0 - 0.09982697761452 )**2;
end;
else _vqmvar + 0.5;
if not missing( Smoker1 ) then do;
   CLUS2vads [1] + ( Smoker1 - 0.23840148022303 )**2;
   CLUS2vads [2] + ( Smoker1 - 0.02692721593642 )**2;
   CLUS2vads [3] + ( Smoker1 - -0.09982697761452 )**2;
end;
else _vqmvar + 0.5;
if not missing( Stroke0 ) then do;
   CLUS2vads [1] + ( Stroke0 - -0.33246781994988 )**2;
   CLUS2vads [2] + ( Stroke0 - 0.09899503396332 )**2;
   CLUS2vads [3] + ( Stroke0 - 0.11593395766771 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Stroke1 ) then do;
   CLUS2vads [1] + ( Stroke1 - 0.33246781994988 )**2;
   CLUS2vads [2] + ( Stroke1 - -0.09899503396332 )**2;
   CLUS2vads [3] + ( Stroke1 - -0.11593395766771 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( Veggies0 ) then do;
   CLUS2vads [1] + ( Veggies0 - 0.19894133752745 )**2;
   CLUS2vads [2] + ( Veggies0 - 0.02947367026096 )**2;
   CLUS2vads [3] + ( Veggies0 - -0.08449776324794 )**2;
end;
else _vqmvar + 0.5;
if not missing( Veggies1 ) then do;
   CLUS2vads [1] + ( Veggies1 - -0.19894133752745 )**2;
   CLUS2vads [2] + ( Veggies1 - -0.02947367026096 )**2;
   CLUS2vads [3] + ( Veggies1 - 0.08449776324794 )**2;
end;
else _vqmvar + 0.5;
if not missing( T_Education ) then do;
   CLUS2vads [1] + ( T_Education - -0.5462482496917 )**2;
   CLUS2vads [2] + ( T_Education - -0.20906465690137 )**2;
   CLUS2vads [3] + ( T_Education - 0.2538597437855 )**2;
end;
else _vqmvar + 1;
if not missing( T_GenHlth ) then do;
   CLUS2vads [1] + ( T_GenHlth - 0.95371189239256 )**2;
   CLUS2vads [2] + ( T_GenHlth - -0.00540151959237 )**2;
   CLUS2vads [3] + ( T_GenHlth - -0.38006442013173 )**2;
end;
else _vqmvar + 1;
if not missing( T_Income ) then do;
   CLUS2vads [1] + ( T_Income - -0.71048743945181 )**2;
   CLUS2vads [2] + ( T_Income - -0.36285444842433 )**2;
   CLUS2vads [3] + ( T_Income - 0.34569126920928 )**2;
end;
else _vqmvar + 1;
if not missing( T_MentHlth ) then do;
   CLUS2vads [1] + ( T_MentHlth - 0.35516346401449 )**2;
   CLUS2vads [2] + ( T_MentHlth - 0.22826019089854 )**2;
   CLUS2vads [3] + ( T_MentHlth - -0.18079880346005 )**2;
end;
else _vqmvar + 1;
if not missing( T_PhysHlth ) then do;
   CLUS2vads [1] + ( T_PhysHlth - 0.82505872259016 )**2;
   CLUS2vads [2] + ( T_PhysHlth - -0.03750449849773 )**2;
   CLUS2vads [3] + ( T_PhysHlth - -0.32319681299581 )**2;
end;
else _vqmvar + 1;
_vqnvar = 21 - _vqmvar;
