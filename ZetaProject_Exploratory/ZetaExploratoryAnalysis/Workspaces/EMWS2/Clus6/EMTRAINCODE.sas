...
MAKE outvar=EMWS2.Clus6_OUTVAR;
INITIAL radius=0
;
TRAIN tech=FORGY
;
SAVE outstat=WORK.Clus6_OUTSTAT outmean=EMWS2.Clus6_OUTMEAN;
code file="\\uisnutvdiprof1a\redirected$\bkris2\Documents\ZetaProject\ZetaExploratoryAnalysis\Workspaces\EMWS2\Clus6\DMVQSCORECODE.sas"
group=Clus6
;
run;
quit;
...
*------------------------------------------------------------*;
proc cluster data=EMWS2.Clus6_OUTMEAN method=AVERAGE pseudo outtree=EMWS2.Clus6_CLUSSEED
;
var %dmvqvars;
copy _SEGMENT_;
run;
quit;
proc sort data =EMWS2.Clus6_CLUSSEED out=WORK._SEED_;
by _ncl_;
where (_ccc_ > -99999.0);
run;
data WORK._SEED2_;
...
TRAIN tech=FORGY
;
SAVE outstat=EMWS2.Clus6_OUTSTAT outmean=EMWS2.Clus6_OUTMEAN;
code file="\\uisnutvdiprof1a\redirected$\bkris2\Documents\ZetaProject\ZetaExploratoryAnalysis\Workspaces\EMWS2\Clus6\DMVQSCORECODE.sas"
group=Clus6
;
run;
