...
if not missing( T_Age ) then do;
   CLUS3vads [1] + ( T_Age - -0.15867836606003 )**2;
   CLUS3vads [2] + ( T_Age - -0.56038268344047 )**2;
   CLUS3vads [3] + ( T_Age - 0.50319008505039 )**2;
end;
else _vqmvar + 1;
if not missing( T_BMI ) then do;
   CLUS3vads [1] + ( T_BMI - -0.1563262317558 )**2;
   CLUS3vads [2] + ( T_BMI - -0.06709716321664 )**2;
   CLUS3vads [3] + ( T_BMI - 0.36527628821719 )**2;
end;
else _vqmvar + 1;
if not missing( AnyHealthcare0 ) then do;
   CLUS3vads [1] + ( AnyHealthcare0 - -0.15940630304339 )**2;
   CLUS3vads [2] + ( AnyHealthcare0 - 1.82866856420237 )**2;
   CLUS3vads [3] + ( AnyHealthcare0 - -0.13782599435923 )**2;
end;
else _vqmvar + 0.5;
if not missing( AnyHealthcare1 ) then do;
   CLUS3vads [1] + ( AnyHealthcare1 - 0.15940630304339 )**2;
   CLUS3vads [2] + ( AnyHealthcare1 - -1.82866856420237 )**2;
   CLUS3vads [3] + ( AnyHealthcare1 - 0.13782599435923 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( CholCheck0 ) then do;
   CLUS3vads [1] + ( CholCheck0 - -0.13978817571977 )**2;
   CLUS3vads [2] + ( CholCheck0 - 1.65490224861074 )**2;
   CLUS3vads [3] + ( CholCheck0 - -0.13465971807765 )**2;
end;
else _vqmvar + 0.5;
if not missing( CholCheck1 ) then do;
   CLUS3vads [1] + ( CholCheck1 - 0.13978817571977 )**2;
   CLUS3vads [2] + ( CholCheck1 - -1.65490224861074 )**2;
   CLUS3vads [3] + ( CholCheck1 - 0.13465971807765 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( DiffWalk0 ) then do;
   CLUS3vads [1] + ( DiffWalk0 - 0.28314882531678 )**2;
   CLUS3vads [2] + ( DiffWalk0 - 0.11844125583795 )**2;
   CLUS3vads [3] + ( DiffWalk0 - -0.66078242977828 )**2;
end;
else _vqmvar + 0.5;
if not missing( DiffWalk1 ) then do;
   CLUS3vads [1] + ( DiffWalk1 - -0.28314882531678 )**2;
   CLUS3vads [2] + ( DiffWalk1 - -0.11844125583795 )**2;
   CLUS3vads [3] + ( DiffWalk1 - 0.66078242977828 )**2;
end;
else _vqmvar + 0.5;
if not missing( HeartDiseaseorAttack0 ) then do;
   CLUS3vads [1] + ( HeartDiseaseorAttack0 - 0.17436268082639 )**2;
   CLUS3vads [2] + ( HeartDiseaseorAttack0 - 0.13849921308042 )**2;
   CLUS3vads [3] + ( HeartDiseaseorAttack0 - -0.42454487922081 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HeartDiseaseorAttack1 ) then do;
   CLUS3vads [1] + ( HeartDiseaseorAttack1 - -0.17436268082639 )**2;
   CLUS3vads [2] + ( HeartDiseaseorAttack1 - -0.13849921308042 )**2;
   CLUS3vads [3] + ( HeartDiseaseorAttack1 - 0.42454487922081 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighBP0 ) then do;
   CLUS3vads [1] + ( HighBP0 - 0.17692023777793 )**2;
   CLUS3vads [2] + ( HighBP0 - 0.24082739119872 )**2;
   CLUS3vads [3] + ( HighBP0 - -0.45775100309535 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighBP1 ) then do;
   CLUS3vads [1] + ( HighBP1 - -0.17692023777793 )**2;
   CLUS3vads [2] + ( HighBP1 - -0.24082739119872 )**2;
   CLUS3vads [3] + ( HighBP1 - 0.45775100309535 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol0 ) then do;
   CLUS3vads [1] + ( HighChol0 - 0.12114485579284 )**2;
   CLUS3vads [2] + ( HighChol0 - 0.22772460390353 )**2;
   CLUS3vads [3] + ( HighChol0 - -0.33033964368659 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol1 ) then do;
   CLUS3vads [1] + ( HighChol1 - -0.12114485579284 )**2;
   CLUS3vads [2] + ( HighChol1 - -0.22772460390353 )**2;
   CLUS3vads [3] + ( HighChol1 - 0.33033964368659 )**2;
end;
else _vqmvar + 0.5;
if not missing( HvyAlcoholConsump0 ) then do;
   CLUS3vads [1] + ( HvyAlcoholConsump0 - -0.02408310420702 )**2;
   CLUS3vads [2] + ( HvyAlcoholConsump0 - -0.05536354085469 )**2;
   CLUS3vads [3] + ( HvyAlcoholConsump0 - 0.0683850519301 )**2;
end;
else _vqmvar + 0.5;
if not missing( HvyAlcoholConsump1 ) then do;
   CLUS3vads [1] + ( HvyAlcoholConsump1 - 0.02408310420702 )**2;
   CLUS3vads [2] + ( HvyAlcoholConsump1 - 0.05536354085469 )**2;
   CLUS3vads [3] + ( HvyAlcoholConsump1 - -0.0683850519301 )**2;
end;
else _vqmvar + 0.5;
if not missing( NoDocbcCost0 ) then do;
   CLUS3vads [1] + ( NoDocbcCost0 - 0.11684977643206 )**2;
   CLUS3vads [2] + ( NoDocbcCost0 - -0.46602685784198 )**2;
   CLUS3vads [3] + ( NoDocbcCost0 - -0.13418672139094 )**2;
end;
else _vqmvar + 0.5;
if not missing( NoDocbcCost1 ) then do;
   CLUS3vads [1] + ( NoDocbcCost1 - -0.11684977643206 )**2;
   CLUS3vads [2] + ( NoDocbcCost1 - 0.46602685784198 )**2;
   CLUS3vads [3] + ( NoDocbcCost1 - 0.13418672139094 )**2;
end;
else _vqmvar + 0.5;
if not missing( T_Education ) then do;
   CLUS3vads [1] + ( T_Education - 0.26458259229152 )**2;
   CLUS3vads [2] + ( T_Education - -0.26517684527461 )**2;
   CLUS3vads [3] + ( T_Education - -0.51635383171147 )**2;
end;
else _vqmvar + 1;
if not missing( T_GenHlth ) then do;
   CLUS3vads [1] + ( T_GenHlth - -0.4105817101404 )**2;
   CLUS3vads [2] + ( T_GenHlth - -0.03593563476583 )**2;
   CLUS3vads [3] + ( T_GenHlth - 0.92163978458849 )**2;
end;
else _vqmvar + 1;
if not missing( T_Income ) then do;
   CLUS3vads [1] + ( T_Income - 0.35653068533571 )**2;
   CLUS3vads [2] + ( T_Income - -0.37502511426436 )**2;
   CLUS3vads [3] + ( T_Income - -0.69103836652373 )**2;
end;
else _vqmvar + 1;
if not missing( T_MentHlth ) then do;
   CLUS3vads [1] + ( T_MentHlth - -0.17326952107838 )**2;
   CLUS3vads [2] + ( T_MentHlth - 0.11979028407949 )**2;
   CLUS3vads [3] + ( T_MentHlth - 0.35263926673846 )**2;
end;
else _vqmvar + 1;
if not missing( T_PhysHlth ) then do;
   CLUS3vads [1] + ( T_PhysHlth - -0.34536224814085 )**2;
   CLUS3vads [2] + ( T_PhysHlth - -0.0868770005514 )**2;
   CLUS3vads [3] + ( T_PhysHlth - 0.79047877194886 )**2;
end;
else _vqmvar + 1;
_vqnvar = 15 - _vqmvar;
