...
if not missing( T_Age ) then do;
   CLUS5vads [1] + ( T_Age - -0.20557312887079 )**2;
   CLUS5vads [2] + ( T_Age - -0.43579154830173 )**2;
   CLUS5vads [3] + ( T_Age - -0.45670216788193 )**2;
   CLUS5vads [4] + ( T_Age - 0.58834386654789 )**2;
end;
else _vqmvar + 1;
if not missing( T_BMI ) then do;
   CLUS5vads [1] + ( T_BMI - -0.19269777944544 )**2;
   CLUS5vads [2] + ( T_BMI - 0.16551306855476 )**2;
   CLUS5vads [3] + ( T_BMI - -0.19435130591951 )**2;
   CLUS5vads [4] + ( T_BMI - 0.33367049415987 )**2;
end;
else _vqmvar + 1;
if not missing( AnyHealthcare0 ) then do;
   CLUS5vads [1] + ( AnyHealthcare0 - -0.14221708725779 )**2;
   CLUS5vads [2] + ( AnyHealthcare0 - 1.12378721750795 )**2;
   CLUS5vads [3] + ( AnyHealthcare0 - 0.42076379323772 )**2;
   CLUS5vads [4] + ( AnyHealthcare0 - -0.15353369816396 )**2;
end;
else _vqmvar + 0.5;
if not missing( AnyHealthcare1 ) then do;
   CLUS5vads [1] + ( AnyHealthcare1 - 0.14221708725779 )**2;
   CLUS5vads [2] + ( AnyHealthcare1 - -1.12378721750795 )**2;
   CLUS5vads [3] + ( AnyHealthcare1 - -0.42076379323772 )**2;
   CLUS5vads [4] + ( AnyHealthcare1 - 0.15353369816396 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( CholCheck0 ) then do;
   CLUS5vads [1] + ( CholCheck0 - -0.14003274976357 )**2;
   CLUS5vads [2] + ( CholCheck0 - -0.13918619700347 )**2;
   CLUS5vads [3] + ( CholCheck0 - 3.57057730835078 )**2;
   CLUS5vads [4] + ( CholCheck0 - -0.14003274976372 )**2;
end;
else _vqmvar + 0.5;
if not missing( CholCheck1 ) then do;
   CLUS5vads [1] + ( CholCheck1 - 0.14003274976357 )**2;
   CLUS5vads [2] + ( CholCheck1 - 0.13918619700347 )**2;
   CLUS5vads [3] + ( CholCheck1 - -3.57057730835078 )**2;
   CLUS5vads [4] + ( CholCheck1 - 0.14003274976372 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( DiffWalk0 ) then do;
   CLUS5vads [1] + ( DiffWalk0 - 0.28567328237922 )**2;
   CLUS5vads [2] + ( DiffWalk0 - -0.19474873318764 )**2;
   CLUS5vads [3] + ( DiffWalk0 - 0.14123787949882 )**2;
   CLUS5vads [4] + ( DiffWalk0 - -0.49277110153324 )**2;
end;
else _vqmvar + 0.5;
if not missing( DiffWalk1 ) then do;
   CLUS5vads [1] + ( DiffWalk1 - -0.28567328237922 )**2;
   CLUS5vads [2] + ( DiffWalk1 - 0.19474873318764 )**2;
   CLUS5vads [3] + ( DiffWalk1 - -0.14123787949882 )**2;
   CLUS5vads [4] + ( DiffWalk1 - 0.49277110153324 )**2;
end;
else _vqmvar + 0.5;
if not missing( HeartDiseaseorAttack0 ) then do;
   CLUS5vads [1] + ( HeartDiseaseorAttack0 - 0.18970878944578 )**2;
   CLUS5vads [2] + ( HeartDiseaseorAttack0 - -0.03090346532043 )**2;
   CLUS5vads [3] + ( HeartDiseaseorAttack0 - 0.15984151747416 )**2;
   CLUS5vads [4] + ( HeartDiseaseorAttack0 - -0.36785931300907 )**2;
end;
else _vqmvar + 0.5;
if not missing( HeartDiseaseorAttack1 ) then do;
   CLUS5vads [1] + ( HeartDiseaseorAttack1 - -0.18970878944578 )**2;
   CLUS5vads [2] + ( HeartDiseaseorAttack1 - 0.03090346532043 )**2;
   CLUS5vads [3] + ( HeartDiseaseorAttack1 - -0.15984151747416 )**2;
   CLUS5vads [4] + ( HeartDiseaseorAttack1 - 0.36785931300907 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighBP0 ) then do;
   CLUS5vads [1] + ( HighBP0 - 0.23603694458682 )**2;
   CLUS5vads [2] + ( HighBP0 - -0.01888915760665 )**2;
   CLUS5vads [3] + ( HighBP0 - 0.34842957893295 )**2;
   CLUS5vads [4] + ( HighBP0 - -0.48295501527646 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighBP1 ) then do;
   CLUS5vads [1] + ( HighBP1 - -0.23603694458682 )**2;
   CLUS5vads [2] + ( HighBP1 - 0.01888915760665 )**2;
   CLUS5vads [3] + ( HighBP1 - -0.34842957893295 )**2;
   CLUS5vads [4] + ( HighBP1 - 0.48295501527646 )**2;
end;
else _vqmvar + 0.5;
if not missing( HighChol0 ) then do;
   CLUS5vads [1] + ( HighChol0 - 0.16139262072761 )**2;
   CLUS5vads [2] + ( HighChol0 - -0.00511087505953 )**2;
   CLUS5vads [3] + ( HighChol0 - 0.30807748643116 )**2;
   CLUS5vads [4] + ( HighChol0 - -0.34158531972324 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HighChol1 ) then do;
   CLUS5vads [1] + ( HighChol1 - -0.16139262072761 )**2;
   CLUS5vads [2] + ( HighChol1 - 0.00511087505953 )**2;
   CLUS5vads [3] + ( HighChol1 - -0.30807748643116 )**2;
   CLUS5vads [4] + ( HighChol1 - 0.34158531972324 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HvyAlcoholConsump0 ) then do;
   CLUS5vads [1] + ( HvyAlcoholConsump0 - -0.02818144453775 )**2;
   CLUS5vads [2] + ( HvyAlcoholConsump0 - -0.00911911178628 )**2;
   CLUS5vads [3] + ( HvyAlcoholConsump0 - -0.08447459076098 )**2;
   CLUS5vads [4] + ( HvyAlcoholConsump0 - 0.06679658167862 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( HvyAlcoholConsump1 ) then do;
   CLUS5vads [1] + ( HvyAlcoholConsump1 - 0.02818144453775 )**2;
   CLUS5vads [2] + ( HvyAlcoholConsump1 - 0.00911911178628 )**2;
   CLUS5vads [3] + ( HvyAlcoholConsump1 - 0.08447459076098 )**2;
   CLUS5vads [4] + ( HvyAlcoholConsump1 - -0.06679658167862 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( NoDocbcCost0 ) then do;
   CLUS5vads [1] + ( NoDocbcCost0 - 0.20787214958554 )**2;
   CLUS5vads [2] + ( NoDocbcCost0 - -1.74769306088834 )**2;
   CLUS5vads [3] + ( NoDocbcCost0 - -0.20625954679033 )**2;
   CLUS5vads [4] + ( NoDocbcCost0 - 0.20740629260845 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( NoDocbcCost1 ) then do;
   CLUS5vads [1] + ( NoDocbcCost1 - -0.20787214958554 )**2;
   CLUS5vads [2] + ( NoDocbcCost1 - 1.74769306088834 )**2;
   CLUS5vads [3] + ( NoDocbcCost1 - 0.20625954679033 )**2;
   CLUS5vads [4] + ( NoDocbcCost1 - -0.20740629260845 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( T_Education ) then do;
   CLUS5vads [1] + ( T_Education - 0.32587217988025 )**2;
   CLUS5vads [2] + ( T_Education - -0.40035526597523 )**2;
   CLUS5vads [3] + ( T_Education - -0.02798599569065 )**2;
   CLUS5vads [4] + ( T_Education - -0.47980613871508 )**2;
end;
else _vqmvar + 1;
if not missing( T_GenHlth ) then do;
   CLUS5vads [1] + ( T_GenHlth - -0.48056390670463 )**2;
   CLUS5vads [2] + ( T_GenHlth - 0.44826656768919 )**2;
   CLUS5vads [3] + ( T_GenHlth - -0.23730961963621 )**2;
   CLUS5vads [4] + ( T_GenHlth - 0.78931496141511 )**2;
end;
else _vqmvar + 1;
if not missing( T_Income ) then do;
   CLUS5vads [1] + ( T_Income - 0.43322181742303 )**2;
   CLUS5vads [2] + ( T_Income - -0.66609603736279 )**2;
   CLUS5vads [3] + ( T_Income - -0.08075449199708 )**2;
   CLUS5vads [4] + ( T_Income - -0.58845081939876 )**2;
end;
else _vqmvar + 1;
if not missing( T_MentHlth ) then do;
   CLUS5vads [1] + ( T_MentHlth - -0.1818637980493 )**2;
   CLUS5vads [2] + ( T_MentHlth - 0.48612648890471 )**2;
   CLUS5vads [3] + ( T_MentHlth - 0.07342277163118 )**2;
   CLUS5vads [4] + ( T_MentHlth - 0.17427969350545 )**2;
end;
else _vqmvar + 1;
if not missing( T_PhysHlth ) then do;
   CLUS5vads [1] + ( T_PhysHlth - -0.36106663585347 )**2;
   CLUS5vads [2] + ( T_PhysHlth - 0.37778601926951 )**2;
   CLUS5vads [3] + ( T_PhysHlth - -0.15097296445797 )**2;
   CLUS5vads [4] + ( T_PhysHlth - 0.57615013990261 )**2;
end;
else _vqmvar + 1;
_vqnvar = 15 - _vqmvar;
